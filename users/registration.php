...
<html lang="en">
  <head>
    ...
    <title>IIITN Recruitment portal| User Registration</title>
  ...
  <body>
	...
	<hr />
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">Recruitment portal</h2>
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullName" required="required" autofocus>
		            ...
		            <input type="password" class="form-control" placeholder="Password" required="required" name="password"><br >
		             <input type="text" class="form-control" maxlength="10" name="contactNo" placeholder="contact number" required="required" autofocus>
		            <br>
