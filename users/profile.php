...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',address='$address',gender='$gender',age='$age',pincode='$pincode' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>RP | User Change Password</title>
