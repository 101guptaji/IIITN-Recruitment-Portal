...
$query=mysqli_query($con,"SELECT * FROM users WHERE userEmail='$email' and contactNo='$Mobileno'");
$num=mysqli_fetch_array($query);
if($num>0)
{
mysqli_query($con,"update users set password='$password' WHERE userEmail='$email' and contactNo='$Mobileno' ");
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff">IIITN Recruitment portal</h3>
	<hr />
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
 ...
 WHERE userEmail='".$_POST['username']."' and password='"($_POST['password'])."'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="dashboard.php";//
...
<html lang="en">
  <head>
    ...
    <title>Recruitment portal | User Login</title>
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff">Recruitment portal</h3>
	<hr />
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading">sign in now</h2>
		        <p style="padding-left:4%; padding-top:2%;  color:red">
